...
<ThumbHashPicture src='./images/astro.png' alt='Astro banner saying build the web you want' />
...
<ThumbHashPicture src='./images/tailwind.jpg' alt='Tailwind CSS banner' />
...
<div className='not-prose grid w-full gap-4 md:grid-cols-2 grid-cols-1'>
    ...
    <div
        ...
        style={`background: center / cover url(${await getThumbHashDataUrl(thumbHashExample.src)});`}
