...
<BlurHashPicture src={astro} alt='Astro banner saying build the web you want' aspectRatio='41:20' />
...
### Tailwind CSS: Crafting Elegant Aesthetics

<BlurHashPicture src={tailwind} alt='Tailwind CSS banner' aspectRatio='2:1' />
...
<div className='not-prose flex flex-row items-center gap-x-4'>
    <figure className='flex aspect-video w-1/2 items-center justify-center rounded-lg bg-slate-200 dark:bg-slate-800'>
        <Icon name='logos:javascript' class='aspect-square h-1/2 w-1/2' />
    </figure>
    <figure className='flex aspect-video w-1/2 items-center justify-center rounded-lg bg-slate-200 dark:bg-slate-800'>
        <Icon name='logos:typescript-icon' class='aspect-square h-1/2 w-1/2' />
    </figure>
</div>
...
<div className='mx-auto flex aspect-video h-full w-full max-w-[376px] items-center justify-center rounded-lg bg-slate-800'>
