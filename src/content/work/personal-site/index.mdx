...
<figure className='not-prose mx-auto flex aspect-video h-full w-2/3 max-w-[376px] items-center justify-center rounded-lg bg-slate-200 p-10 dark:bg-slate-800'>
    <Icon name='feather' class='aspect-square h-1/2 w-1/2' />
</figure>

A feather, reminiscent of a falcon, adds a personal touch to the brand. The choice of a feather symbolizes lightness, precision, and trust, aligning with the characteristics of a falcon. It becomes a visual representation of identity, embodying the values and aspirations that define my online presence.
